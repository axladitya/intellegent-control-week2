...
file_path = "color-detection-data-set/colors.csv"  # Sesuaikan dengan lokasi file
...
while True:
    ...
    cv2.rectangle(frame, (x2_start, y2_start), (x2_end, y2_end), (0, 255, 255), 2)
    cv2.putText(frame, f'{color_pred2}', (x2_start, y2_start - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 165, 0), 2)

    cv2.putText(frame, f'Color 1: {color_pred1} (Acc: {accuracy_1:.2f}%)', (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 69, 0), 2)
    cv2.putText(frame, f'Color 2: {color_pred2} (Acc: {accuracy_2:.2f}%)', (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 165, 0), 2)
